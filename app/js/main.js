...
/* harmony import */ var _components_record_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/record-slider */ "./src/js/components/record-slider.js");
/* harmony import */ var _components_record_slider__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_record_slider__WEBPACK_IMPORTED_MODULE_0__);
...
var tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_2__["default"]('directions-tabs'); // Получение высоты шапки сайта (не забудьте вызвать функцию)
...
/***/ "./src/js/components/record-slider.js":
/*!********************************************!*\
  !*** ./src/js/components/record-slider.js ***!
  \********************************************/
/***/ (() => {

var mySwiper = new Swiper('.our-record__slider', {
  // Optional parameters
  loop: true,
  slidesPerView: 6,
  centeredSlides: true,
...
var swiperPrev = document.querySelector('.our-record__arrows .main-arrows__arrow--left');
var swiperNext = document.querySelector('.our-record__arrows .main-arrows__arrow--right');
